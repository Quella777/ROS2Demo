...
bool status_interfaces__msg__system_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // memory_totla
    PyObject * field = PyObject_GetAttrString(_pymsg, "memory_totla");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->memory_totla = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // memory_available
...
PyObject * status_interfaces__msg__system_status__convert_to_py(void * raw_ros_message)
{
  ...
  {  // memory_totla
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->memory_totla);
    {
      int rc = PyObject_SetAttrString(_pymessage, "memory_totla", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
