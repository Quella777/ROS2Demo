...
struct SystemStatus_
{
  ...
  using _memory_totla_type =
    float;
  _memory_totla_type memory_totla;
  ...
  Type & set__memory_totla(
    const float & _arg)
  {
    this->memory_totla = _arg;
    return *this;
  }
  ...
  bool operator==(const SystemStatus_ & other) const
  {
    ...
    if (this->memory_totla != other.memory_totla) {
      return false;
    }
