...
class Init_SystemStatus_memory_totla
{
public:
  explicit Init_SystemStatus_memory_totla(::status_interfaces::msg::SystemStatus & msg)
  : msg_(msg)
  {}
  Init_SystemStatus_memory_available memory_totla(::status_interfaces::msg::SystemStatus::_memory_totla_type arg)
  {
    msg_.memory_totla = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_SystemStatus_memory_totla memory_percent(::status_interfaces::msg::SystemStatus::_memory_percent_type arg)
  {
    msg_.memory_percent = std::move(arg);
    return Init_SystemStatus_memory_totla(msg_);
  }
