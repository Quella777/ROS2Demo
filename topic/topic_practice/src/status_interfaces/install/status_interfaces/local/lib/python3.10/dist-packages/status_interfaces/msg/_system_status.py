...
class SystemStatus(metaclass=Metaclass_SystemStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.memory_totla = kwargs.get('memory_totla', float())
    ...
    def __eq__(self, other):
        ...
        if self.memory_percent != other.memory_percent:
            return False
        if self.memory_totla != other.memory_totla:
            return False
    ...
    @builtins.property
    def memory_totla(self):
        """Message field 'memory_totla'."""
        return self._memory_totla

    @memory_totla.setter
    def memory_totla(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'memory_totla' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'memory_totla' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._memory_totla = value
